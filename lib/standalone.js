...
var convert = module.exports.convert = function(options) {
	...
	return bundler.metabook.fromArticles([{
		...
		// allow caller to pass in a memoizing constructor for the siteinfo
		var siteinfo = typeof options.siteinfo === 'function' ?
			options.siteinfo(bundler, metabook.wikis, options.log) :
			new bundler.siteinfo(metabook.wikis, options.log);
